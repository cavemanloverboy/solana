...
pub struct TransactionBatchProcessor<FG: ForkGraph> {
    ...
    cached_builtin_program_cache: RwLock<ProgramCacheForTxBatch>,
...
impl<FG: ForkGraph> Default for TransactionBatchProcessor<FG> {
    fn default() -> Self {
        Self {
            ...
            cached_builtin_program_cache: RwLock::new(ProgramCacheForTxBatch::new(Slot::default())),
...
impl<FG: ForkGraph> TransactionBatchProcessor<FG> {
    ...
    pub fn new_from(&self, slot: Slot, epoch: Epoch) -> Self {
        ...
        Self {
            ...
            cached_builtin_program_cache: RwLock::new(cache),
    ...
    pub fn load_and_execute_sanitized_transactions<CB: TransactionProcessingCallback>(
        ...
        let mut program_cache_for_tx_batch =
            self.cached_builtin_program_cache.read().unwrap().clone();
    ...
    pub fn add_builtin(&self, program_id: Pubkey, builtin: ProgramCacheEntry) {
        ...
        self.cached_builtin_program_cache
            .write()
            .unwrap()
